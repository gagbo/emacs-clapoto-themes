...
(clapoto-themes-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF)) ; col 1 GUI/24bit
  ...
  (clapoto-intense_hue3 clapoto-intense_magenta)
  ...
  (clapoto-neutral_hue3 clapoto-neutral_magenta)
  ...
  (clapoto-faded_hue3 clapoto-faded_magenta)
  (clapoto-faded_hue4 clapoto-faded_blue)
  (clapoto-faded_hue5 clapoto-faded_orange)

  (clapoto-comments clapoto-neutral_yellow)
